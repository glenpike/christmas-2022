...
export default function Home() {
  ...
  const renderForm = () => {
    return (
      <>
        <h3>Make a christmas limerick for me</h3>
        <form onSubmit={onSubmit}>
          ...
          />
          <input type="submit" value="Generate a limerick" disabled={disabled} />
        </form>
      </>
    );
  };
    ...
    <div>
      ...
      <footer className={styles.footer}>
        <p>
          ...
          <a href="https://openai.com/dall-e-2/">DALL-E 2</a> an AI model. I
          used prompts like{" "}
          <em>
            'A Christmas scene set in Cornwall in the style of Pieter Bruegel'
          </em>{" "}
          to make them.
        </p>
        <p>
          The limerick is generated by{" "}
          <a href="https://openai.com/blog/chatgpt/">ChatGPT</a>, an AI model which generates
