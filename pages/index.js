      ...
      <>
        ...
        {loading == false ? (
          <form onSubmit={onSubmit}>
            ...
            />
            <input type="submit" value="Generate a limerick" />
          </form>
        ) : (
          ...
          <div className={styles.layout_right}>
            ...
            <div className={styles.blurb}>
              <p>
                ...
                <a href="https://openai.com/dall-e-2/">DALL-E 2</a> an AI model.
                I used prompts like{" "}
                <em>
              ...
              <p>
                ...
                <a href="https://openai.com/blog/chatgpt/">ChatGPT</a>, an AI
                model which generates all sorts of text. This was done with{" "}
                <em>Make a Christmas limerick about someone called ...</em>
              </p>
              <p>
                Sometimes the AI will return a rude text and it's not the best
                at limericks/rhyming!
                <br />
                Apologies.
              </p>
              <p className={styles.smaller_text}><a href="https://github.com/glenpike/christmas-2022">Made</a> by Glen Pike with help from <a href="https://beta.openai.com/docs/quickstart/build-your-application">OpenAI</a></p>
            </div>
          </div>
        </div>
      </main>
